...
import { parseArticleContent, quillDeltaToReact } from "../utils/formatArticle";
...
export default function ArticlePage() {
    ...
    const articleBlocks = quillDeltaToReact(parsedContent, preferencesConsent);
